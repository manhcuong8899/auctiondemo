...
$('#aUpdateDialog').on('show.bs.modal', function(e) {
    ...
    var inpput_starttime = 'starttime'+productid;
    var inpput_endtime = 'endtime'+productid;
    var aprice = $('#'+inpput_price).val();
    var aquantity = $('#'+inpput_quantity).val();
    var starttime = $('#'+inpput_starttime).val();
    var endtime = $('#'+inpput_endtime).val();
    productname = $(e.relatedTarget).data('productname');
    var url = updaterurl+'/'+trimSpace(aprice)+'/'+trimSpace(aquantity)+'/'+trimSpace(starttime)+'/'+trimSpace(endtime);
