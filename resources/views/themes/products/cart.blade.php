    ...
    <div class="container">
        <div class="product-detail">
            <div class="row">
                <div class="col-sm-8">
                    <div class="cart_list">
                        <h2 class="heading">Sản phẩm đã tham gia đấu giá (<span class="num_product">{{$cart->count()}}</span>)</h2>
                ...
                <div class="col-sm-4">
                    <div id="ch4_summaryContent">
                        ...
                        <div id="ch4_summaryButtons" class="ch4_summaryRowEnd ">
                            <a href="{{url('checkout')}}" class="ch4_btn ch4_btnOrange ch4_itemName">ĐẤU GIÁ</a>
                        </div>
                    </div>
