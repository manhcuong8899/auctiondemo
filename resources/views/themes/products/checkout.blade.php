                    ...
                    <div class="summarySection">
                        ...
                        <div class="summaryContent">
                            <div class="summaryCol clearfix">
                                ...
                                <div class="right"><span class="sum_price">{{number_format($total,'8',',','.')}}</span></div>
                            </div>
                            <div class="summaryCol clearfix">
                                <div class="left">CHIẾT KHẤU</div>
                                <div class="right"><span class="sum_sale">{{number_format($coupons,'8',',','.')}}</span></div>
                            </div>
                            <div class="summaryCol clearfix">
                            ...
                            <div class="summaryCol clearfix summaryTotal">
                                ...
                                <div class="right"><span class="sum_total">{{number_format($total-$coupons,'8',',','.')}}</span></div>
                            </div>
                            ...
                            <div class="summaryList">
                                ...
                                <div class="cartItem">
                                    ...
                                    <div class="summaryItemContent">
                                        ...
                                        <p class="orange">{{number_format(($carts->price*$carts->qty) - $carts->options->coupons,'8',',','.')}} ETH</p>
                                    </div>
                                </div>
                                @endforeach
                            </div>
