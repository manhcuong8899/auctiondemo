        ...
        <div class="acc-right">
            ...
            <form class="login-form" role="form" method="POST" action="{{ url('members/update') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" required @if($profile!=null)value="{{$profile->wallet}}"@endif name="wallet">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" required @if($profile!=null)value="{{$profile->birthday}}"@endif name="birthday" id="birthday">
                </div>
