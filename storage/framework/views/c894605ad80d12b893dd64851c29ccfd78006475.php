    ...
    <section class="content">
        <div class="row">
            ...
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" action="<?php echo e(url('admin/cate/create/'.$group)); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <?php if($parent!=0): ?>
                                    <option value="<?php echo e($viewparent->id); ?>"><?php echo e($viewparent->name); ?></option>
                                <?php else: ?>
                                                               <option value="0">Danh mục gốc</option>
                     <?php endif; ?>


                                <?php echo e(cate_parent($data)); ?>
            ...
            <div class="col-md-8">
        <!-- Default box -->
                <form role="form" action="<?php echo e(url('admin/cate/order')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <?php foreach( $listCate as $list ): ?>
                        <tr>
							...
							<td>
                                ...
                                <?php else: ?>
                                    <?php echo e($list->name); ?> <a class="btn btn-xs btn-default btn-flat" href="<?php echo e(url('admin/articles/create/'.$group.'?cateurl='.$list->id)); ?>">
                            ...
                            <?php else: ?>
                                <td>
                                    <?php if($list->children->count()!=0): ?>
                                        <b><a href="<?php echo e(url('admin/cate/'.$group.'?parent='.$list->id)); ?>" style="text-decoration: none"><?php echo e($list->name); ?> (<b><font color="#ff0000"><?php echo e($list->children->count()); ?></font></b>) </a></b>
                                    <?php else: ?>
                                        <?php echo e($list->name); ?> <a class="btn btn-xs btn-default btn-flat" href="<?php echo e(url('admin/create/'.$group.'?cateurl='.$list->id)); ?>">
        ...
        <div class="modal fade" tabindex="-1" role="dialog" id="Addmenu">
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    ...
                    <?php echo Form::open(['method' => 'POST', 'id'=>'FormStatus']); ?>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <select class="form-control" name="groupmenu" id="groupmenu">
                                        <?php foreach($groupmenus as $value): ?>
...
<?php $__env->startSection('footerscripts'); ?>
    ...
    <script>
        $('#groupmenu').change(function(){
            ...
            $.ajax({
                url: '<?php echo e(url('admin/menus')); ?>/'+data,
                dataType: "html",
                type: "post",
                data: {_method: 'post', _token: '<?php echo e(csrf_token()); ?>', data: data}
