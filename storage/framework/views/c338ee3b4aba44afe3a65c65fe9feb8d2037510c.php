        ...
        <div class="modal-content pd-10">
            <div class="modal-header clearfix">
                ...
                <h3 class="modal-title">
                    <span>Thêm vào danh sách đấu giá thành công</span>
                    <span data-dismiss="modal" class="btn_continue_shopping" title="Continue Shopping">Chọn thêm sản phẩm đấu giá</span>
                </h3>
            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-7">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <h3 class="product-title" name="nameproduct"></h3>
                                        ...
                                        <div class="product-style" >Giá sàn: <span class="modal-qty" name="priceproduct"></span> ETH</div>
                                </div><!--col-sm-6 -->
                            </div>
                        </div><!--col-sm-6 -->
                        <div class="col-sm-5">
                            <div class="minicart_summery">
                                ...
                                <div class="summary_row">
                                    <div class="summary_label">Giá đặt đấu giá:</div>
                                    <div class="summary_value modal-price" name="pricecart"></div>
                                </div>
                                <div class="summary_row">
                                    <div class="summary_label">Phí đấu giá:</div>
                                    <div class="summary_value modal-ship" name="ship"> Free</div>
                                </div>
                                ...
                                <div class="summary_row summary_btnshowcart">
                                    ...
                                    <a class="summary_btn" href="<?php echo e(url('checkout')); ?>">XÁC NHẬN ĐẤU GIÁ</a>
                                </div>
                            </div>
                        </div><!--col-sm-6 -->
                    </div>
