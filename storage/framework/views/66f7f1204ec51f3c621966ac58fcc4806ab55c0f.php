...
<div id="page"  class="wsmenucontainer clearfix">
    ...
    <!-- ==========  FOOTER : END =========== -->
        ...
        <script type="text/javascript" src="<?php echo e(asset('themes/assets/js/jquery-1.11.3.min.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(asset('themes/assets/bootstrap/js/bootstrap.min.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(asset('themes/assets/js/webslidemenu.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(asset('themes/assets/vendors/owcarousel/owl.carousel.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(asset('themes/assets/vendors/icheck/icheck.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(asset('themes/assets/js/index.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(asset('themes/assets/vendors/validator/jquery.validate.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(asset('themes/assets/vendors/validator/additional-methods.js')); ?>"></script>
