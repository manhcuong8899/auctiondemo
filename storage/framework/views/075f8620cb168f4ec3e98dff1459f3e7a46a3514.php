        ...
        <script type="text/javascript">
            $(document).on('ready', function() {
                $('.add-to-cart').click(function(){
                        var price = $('.product-detail .btn-qty').val();
                        var qty =1;
                        var sum = 1*price;
                        ...
                        $.ajax({
                            ...
                            dataType: "json",
                            type: "post",
                            data: {_method: 'post', _token: '<?php echo e(csrf_token()); ?>',productid: productid,quantity: qty,bind: price}
                        }).done(function(data){
                            ...
                            $('#myModalCardView [name="priceproduct"]').html(data.price);
